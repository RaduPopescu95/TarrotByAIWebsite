...
export const handleUpdateFirestore = async (location, updatedData) => {
  try {
    ...
    if (docSnapshot.exists()) {
      ...
      console.log(`Documentul nu există la locația: ${location}. Se va crea documentul.`);
...
export const setOfferAnswer = async (meetingId, offerAnswer, type) => {
  ...
  const updateData = {};
  if (type === "offer") updateData.offer = offerAnswer; // Dacă tipul este 'offer', actualizează proprietatea `offer`
