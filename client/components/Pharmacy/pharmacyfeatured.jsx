            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">Echinacea</Link>
                  </h4>
                  ...
                  <div className="product-cart">
                    ...
                    <Link href="/product-all" className="cart-icon">
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Women’s Care</h6>
                  <h4>
                    <Link href="/product-all">Diclofenac</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Weight</h6>
                  <h4>
                    <Link href="/product-all">Colchicine</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Oral Care</h6>
                  <h4>
                    <Link href="/product-all">Clindamycin Gel</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Women’s Care</h6>
                  <h4>
                    <Link href="/product-all">Aspinin-C</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">L-Carnitine</Link>
                  </h4>
                  <span className="badge">100 pills</span>
                  <div className="product-cart">
                    <div className="cart-price">
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">DyN.O Pre Workout</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Baby Care</h6>
                  <h4>
                    <Link href="/product-all">Tabcin</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">Gemgex</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Weight</h6>
                  <h4>
                    <Link href="/product-all">Tri-Amino</Link>
                  </h4>
                  ...
                  <div className="product-cart">
                    ...
                    <div className="cart-count">
                      ...
                      <Link
                        href="/product-all"
                        className="cart-icon check-icon"
                      >
                        <i className="feather-check" />
                      </Link>
                    </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">Vitamin C+</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Weight</h6>
                  <h4>
                    <Link href="/product-all">Gravol Ginger</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Women’s Care</h6>
                  <h4>
                    <Link href="/product-all">Embryolisse</Link>
                  </h4>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Oral Care</h6>
                  <h4>
                    <Link href="/product-all">Berocca</Link>
                  </h4>
                  <h5 className="delivery">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">Acteane</Link>
                  </h4>
                  <h5 className="delivery">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 aos" data-aos="fade-up">
              <div className="products-card">
                ...
                <div className="product-content">
                  <h6>Home &amp; Health</h6>
                  <h4>
                    <Link href="/product-all">Lactoferrin Plus SB</Link>
                  </h4>
                  <h5 className="delivery">
              ...
              <div className="col-xl-2 col-lg-3 col-md-4">
                <div className="footer-links">
                  ...
                  <ul className="pages-links">
                    <li>
                      <Link href="/about-us">About Doccure</Link>
                    </li>
                    <li>
