                ...
                <ul className="nav">
                  ...
                  <li>
                    <div className="btn log-register">
                      <Link href="/login" className="me-1">
                        <span>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              ...
              <div className="pharmacy-btn aos">
                <Link href="/Pharmacy/pharmacy-search" className="btn">
                  Shop Now
                </Link>
              </div>
            </div>
                ...
                <div className="row align-items-center">
                  <div className="col-md-7">
                    <div className="shop-content">
                      ...
                      <p>Code: CARE12</p>
                      <Link href="/product-all" className="btn">
                        Shop Now
                      </Link>
                    </div>
                  </div>
              ...
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Diabetes</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Cardiac Care</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Stomach Care</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Ayurvedic</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Homeopathy</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Fitness</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Mom &amp; Baby</Link>
                  </div>
                </div>
              </li>
              <li>
                <div className="deals-grid aos" data-aos="fade-up">
                  ...
                  <div className="deals-content">
                    <Link href="/product-all">Devices</Link>
                  </div>
                </div>
              </li>
            </ul>
            ...
            <div className="row">
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Ayush</Link>
                    </h5>
                    <p>400 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Covid Essentials</Link>
                    </h5>
                    <p>924 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Glucometers</Link>
                    </h5>
                    <p>580 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Eye Glasses</Link>
                    </h5>
                    <p>620 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Weight</Link>
                    </h5>
                    <p>740 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Women's Care</Link>
                    </h5>
                    <p>810 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Baby Care</Link>
                    </h5>
                    <p>680 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Home &amp; Health</Link>
                    </h5>
                    <p>440 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Sexual Wellness</Link>
                    </h5>
                    <p>270 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Hands &amp; Feet</Link>
                    </h5>
                    <p>360 Products</p>
                  </div>
                </div>
              ...
              >
                <div className="categorie-grid flex-fill">
                  ...
                  <div className="categorie-content">
                    <h5>
                      <Link href="/product-all">Oral Care</Link>
                    </h5>
                    <p>520 Products</p>
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Home &amp; Health</h6>
                    <h5>
                      <Link href="/product-all">Biotin Tablets</Link>
                    </h5>
                    <p>
                      $200 <span>$300</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Ayush</h6>
                    <h5>
                      <Link href="/product-all">Natural Tooth Paste</Link>
                    </h5>
                    <p>$50</p>
                  </div>
                </div>
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Baby Care</h6>
                    <h5>
                      <Link href="/product-all">Baby Shampoo</Link>
                    </h5>
                    <p>$270</p>
                  </div>
                </div>
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Eye Glasses</h6>
                    <h5>
                      <Link href="/product-all">Oval Frame Glass</Link>
                    </h5>
                    <p>
                      $450 <span>$500</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Devices</h6>
                    <h5>
                      <Link href="/product-all">Infrared Thermometer</Link>
                    </h5>
                    <p>
                      $300 <span>$400</span>
                    </p>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Hands &amp; Feet</h6>
                    <h5>
                      <Link href="/product-all">Eucerin Lotion</Link>
                    </h5>
                    <p>
                      $150 <span>$200</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    ...
                    <h5>
                      <Link href="/product-all">Hand Sanitizer</Link>
                    </h5>
                    <p>$100</p>
                  </div>
                </div>
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Glucometer</h6>
                    <h5>
                      <Link href="/product-all">Glucometer</Link>
                    </h5>
                    <p>
                      $200 <span>$300</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Weight</h6>
                    <h5>
                      <Link href="/product-all">Weight Machine</Link>
                    </h5>
                    <p>$800</p>
                  </div>
                </div>
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Home &amp; Health</h6>
                    <h5>
                      <Link href="/product-all">Papulex Gel</Link>
                    </h5>
                    <p>$70</p>
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Oral Care</h6>
                    <h5>
                      <Link href="/product-all">Electric Tooth Brush</Link>
                    </h5>
                    <p>
                      $60 <span>$100</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Devices</h6>
                    <h5>
                      <Link href="/product-all">Sphygmomanomet</Link>
                    </h5>
                    <p>
                      $450 <span>$500</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Covid Essentials</h6>
                    <h5>
                      <Link href="/product-all">Hand Gloves</Link>
                    </h5>
                    <p>$20</p>
                  </div>
                </div>
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Hands &amp; Feet</h6>
                    <h5>
                      <Link href="/product-all">Cattier Cream</Link>
                    </h5>
                    <p>
                      $120 <span>$150</span>
                    </p>
                ...
                <div className="seller-grid aos" data-aos="fade-up">
                  ...
                  <div className="seller-text">
                    <h6>Women’s Care</h6>
                    <h5>
                      <Link href="/product-all">Calcium Tablets</Link>
                    </h5>
                    <p>
                      $170 <span>$200</span>
                    </p>
