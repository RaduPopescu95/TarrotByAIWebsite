              ...
              <div className="doctor-widget">
                ...
                <div className="doc-info-right d-flex align-items-center justify-content-center">
                  <div className="clinic-booking">
                    <Link className="view-pro-btn" href="/doctor/chat-doctor">
                      Send Message
                    </Link>
                    <Link
                      className="apt-btn"
                    ...
                    <Link href="/Pharmacy/product-all" className="view-pro-btn">
                      Browse Products
                    </Link>
                  </div>
                </div>
                      ...
                      <div className="col-md-6">
                        <div className="clinic-content">
                          <h4 className="clinic-name">
                            <Link href="#">Medlife Medical</Link>
                          </h4>
                          ...
                          <div className="clinic-details mb-0">
                            ...
                            <ul>
                              <li>
                                <Link href={feature01} data-fancybox="gallery2">
                                  <img src={feature01} alt="Feature Image" />
                                </Link>
                              </li>
                              <li>
                                <Link href={feature02} data-fancybox="gallery2">
                                  <img src={feature02} alt="Feature Image" />
                                </Link>
                              </li>
                              <li>
                                <Link href={feature03} data-fancybox="gallery2">
                                  <img src={feature03} alt="Feature Image" />
                                </Link>
                              </li>
                              <li>
                                <Link href={feature04} data-fancybox="gallery2">
