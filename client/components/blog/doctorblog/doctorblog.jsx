...
import Link from "next/link"; //images
import {
  IMG01,
  IMG02,
  IMG08,
                    ...
                    <div className="col">
                      <ul className="nav nav-tabs nav-tabs-solid">
                        <li className="nav-item">
                          <Link className="nav-link active" href="/doctor-blog">
                            Acitive Blog
                          </Link>
                        </li>
                        <li className="nav-item">
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <Link href="#" className="btn btn-success si_accept_confirm">
                Yes
              </Link>
              <button
                type="button"
