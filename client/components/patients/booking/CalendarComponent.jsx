...
const CalendarComponent = ({ setSelectedSlot, selectedSlot, handleUpdateSubmitInfo, handleSubmitInfo, selectedDay, setSelectedDay, selectedMonth, setSelectedMonth, yearlySlots, onEditDaySlots, openAddSlotModal, openDeleteAllSlotsModal, onDeleteSlot, repeatDay, isLoading, isUpdate }) => {
  ...
  const generateDaysInMonth = (year, month) => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const reservedSlots = yearlySlots[month]?.find(slot => slot.day === day)?.reservedSlots || [];
