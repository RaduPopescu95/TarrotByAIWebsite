...
const CalendarSlotComponent = ({ day, slots, onAddSlot, onDeleteAll, onDeleteSlot, repeatDay }) => (
  <div className="tab-pane active show" id={day.toLowerCase()}>
    <div className="slot-box">
      <div className="slot-header">
        ...
        <ul>
          <li>
            <Link href="" className="add-slot" onClick={(e) => { e.preventDefault(); repeatDay(); }}>
              <i className="fa-solid fa-repeat" />  Repeta zi
            </Link>
          </li>
          <li>
            <Link href="" className="add-slot" onClick={(e) => { e.preventDefault(); onAddSlot(); }}>
              <i className="fa-solid fa-plus" /> Adauga ore
            </Link>
          </li>
          <li>
            <Link href="" className="del-slot" onClick={(e) => { e.preventDefault(); onDeleteAll(); }}>
