                              ...
                              <tr>
                                ...
                                {/* <td>
                                  <div className="apponiment-actions d-flex align-items-center">
                                    <Link href="#" className="text-success me-2">
                    ...
                    <div className="upcoming-appointment-card">
                      ...
                      <div className="upcoming-patient-info">
                        <div className="info-details">
                          ...
                          <div className="name-info">
                            {/* <span>#Rez009</span> */}
                            <h6>{rezervariZilnic[0]?.nume}</h6>
                          </div>
                        </div>
                        <div className="date-details">
                          <span>
                            tip consultatie:{" "}
                            {rezervariZilnic[0]?.tipConsultatie}
                          </span>
                          <h6>
                            Astazi, ora {rezervariZilnic[0]?.selectedSlot.slot}
                          </h6>
                        </div>
                      </div>
                      <div className="appointment-card-footer">
                        <h5>
                          ...
                          Consultatie {rezervariZilnic[0]?.tipConsultatie}
                        </h5>
                        <div className="btn-appointments">
                          ...
                          <Link
                            href={`/meeting-admin?meetingCode=${rezervariZilnic[0]?.meetingCode}__${rezervariZilnic[0]?.documentId}`}
                            className="btn"
                          >
                            Începe consultatia
                          </Link>
                    ...
                    {/* <div className="dashboard-card w-100">
                      <div className="dashboard-card-head">
                        ...
                        <div className="card-view-link">
                          <Link href="/doctor/invoices">View All</Link>
                        </div>
                      </div>
                      <div className="dashboard-card-body">
                        <div className="table-responsive">
                  ...
                  <div className="dashboard-chart-col w-100">
                    ...
                    <div className="dashboard-card w-100">
                      <div className="dashboard-card-head">
                        ...
                        <div className="card-view-link">
                          <Link href="/doctor/my-patients">View All</Link>
                        </div>
                      </div>
                      <div className="dashboard-card-body">
