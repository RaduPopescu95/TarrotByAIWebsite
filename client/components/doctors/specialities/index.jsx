...
const DoctorSpecialities = (props) => {
  ...
  const handleUploadCategorii = async (event) => {
    ...
    if (invalidService) {
      showAlert(
        "danger",
        "Există un serviciu cu informații incomplete sau preț nevalid! Asigurați-vă că toate categoriile au nume, timp alocat și preț mai mare de 0."
      );
    ...
    try {
      ...
      showAlert("success", "Categorii salvate cu succes!");
    } catch (error) {
