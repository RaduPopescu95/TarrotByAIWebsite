        ...
        <div className="doctor-filter-inner">
          ...
          <div className="doctor-filter-option">
            ...
            <div className="doctor-filter-sort">
              <ul className="nav">
                <li>
                  <Link href="/patient/doctor-list" id="map-list">
                    <FiMapPin />
                  </Link>
                </li>
                <li>
                  <Link href="/patient/doctor-grid">
                    <FiGrid />
                  </Link>
                </li>
                <li>
                  <Link href="/patient/doctor-list" className="active">
                    <FiList />
                  </Link>
                </li>
              </ul>
          ...
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              <div className="doctor-img">
                <Link href="/patient/doctor-list">
                  <img src={doctor_13} className="img-fluid" alt="" />
                </Link>
                <div className="favourite-btn">
                  <Link href="/patient/map-list" className="favourite-icon">
                    <FiHeart />
                  </Link>
                </div>
              </div>
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr.John Doe</Link>
            ...
            <div className="doc-info-right">
              ...
              <div className="clinic-booking book-appoint">
                <Link className="btn btn-primary" href="/patient/booking1">
                  Book Appointment
                </Link>
                <Link
          ...
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              <div className="doctor-img">
                ...
                <div className="favourite-btn">
                  <Link href="#" className="favourite-icon">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr. Darren Elder</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                ...
                <div className="clinic-details">
                  <p className="doc-location">
                    <FiMapPin />
                    1.1 mi - Georgia, USA <Link href="#">Get Direction</Link>
                  </p>
                  <p className="doc-location">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr. Sofia Brient</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr. Johny Rita</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr. Deborah Angel</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
            ...
            <nav>
              <ul className="pagination justify-content-center">
                <li className="page-item disabled">
                  <Link className="page-link page-prev" href="#" tabIndex={-1}>
