      ...
      <div className="filter-contents">
        ...
        <div className="filter-details">
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapseone" data-bs-toggle="collapse">
                Gender
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapsetwo" data-bs-toggle="collapse">
                Availability
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapsethree" data-bs-toggle="collapse">
                Consultation Fee
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapsefour" data-bs-toggle="collapse">
                Speciality
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapsefive" data-bs-toggle="collapse">
                Experience
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapsesix" data-bs-toggle="collapse">
                Online Consultation
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapseseven" data-bs-toggle="collapse">
                By Rating
              </Link>
            </h4>
          ...
          <div className="filter-grid">
            <h4>
              <Link href="#collapseeight" data-bs-toggle="collapse">
                Languages
              </Link>
            </h4>
