          ...
          <div className="doctor-widget">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link href="/patient/doctor-profile">Dr. Ruby Perrin</Link>
                </h4>
            ...
            <div className="doc-info-right">
              ...
              <div className="clinic-booking">
                <Link href="/patient/doctor-profile" className="view-pro-btn">
                  View Profile
                </Link>
                <Link href="/patient/booking1" className="apt-btn">
                  Book Appointment
                </Link>
              </div>
            </div>
