              ...
              <div className="col-lg-4 col-md-12">
                <div className="on-board-wizard">
                  <ul>
                    ...
                    <li>
                      <Link href="/pages/patient-personalize">
                        <div className="onboarding-progress active">
                          <span>2</span>
                        </div>
                        <div className="onboarding-list">
                    ...
                    <li>
                      <Link href="/pages/patient-family-details">
                    ...
                    <li>
                      <Link href="/pages/patient-dependant-details">
                        <div className="onboarding-progress">
                          <span>5</span>
                        </div>
                        <div className="onboarding-list">
                    ...
                    <li>
                      <Link href="/pages/patient-other-details">
                        <div className="onboarding-progress">
                          <span>6</span>
                        </div>
                        <div className="onboarding-list">
              ...
              <div className="col-lg-8 col-md-12">
                <div className="onboarding-content-box content-wrap">
                              ...
                              <div className="form-group">
                                <div className="checklist-col">
                                  ...
                                  >
                                    ...
                                    <Link href="#" className="add_condition">
                                  ...
                                  >
                                    ...
                                    <Link href="#" className="add_medicine">
                                      <i className="fa fa-plus"></i>
                                    </Link>
                                  </div>
                                </div>
                  ...
                  <div className="onboarding-btn">
                    <Link href="/pages/patient-family-details">Continue</Link>
                  </div>
                </div>
              </div>
            </div>
