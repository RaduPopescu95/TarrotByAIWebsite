            ...
            <div className="col-lg-4 col-md-12">
              <div className="on-board-wizard">
                <ul>
                  ...
                  <li>
                    <Link href="/pages/onboarding-identity">
                  ...
                  <li>
                    <Link href="/pages/onboarding-personalize">
                      <div className="onboarding-progress">
                        <span>3</span>
                      </div>
                      <div className="onboarding-list">
                  ...
                  <li>
                    <Link href="/pages/onboarding-verification">
                      <div className="onboarding-progress">
                        <span>4</span>
                      </div>
                      <div className="onboarding-list">
                  ...
                  <li>
                    <Link href="/pages/onboarding-payments">
                      <div className="onboarding-progress">
                        <span>5</span>
                      </div>
                      <div className="onboarding-list">
                  ...
                  <li>
                    <Link href="/pages/onboarding-preferences">
                      <div className="onboarding-progress">
                        <span>6</span>
                      </div>
                      <div className="onboarding-list">
            ...
            <div className="col-lg-8 col-md-12">
              <div className="onboarding-content-box content-wrap">
                ...
                <div className="onboarding-btn">
                  <Link href="/pages/onboarding-email-otp">Continue</Link>
                </div>
              </div>
            </div>
          </div>
