  ...
  const handleGoogleLogin = () => {
    handleGoogleSignIn()
      .then((userCredentials) => {
        ...
        // let first_name = userCredentials.user.displayName;
        // let last_name = "";
        // let email = userCredentials.user.email;
        // let owner_uid = userCredentials.user.uid;
      ...
      .catch((error) => {
        ...
        setError(
          "Failed to log in with Google. Error message: " + error.message
        );
      });
  };
  ...
  const handleFacebookLogin = () => {
    handleFacebookSignIn()
      ...
      .catch((error) => {
        ...
        setError(
          "Failed to log in with Facebook. Error message: " + error.message
        );
      });
  };
