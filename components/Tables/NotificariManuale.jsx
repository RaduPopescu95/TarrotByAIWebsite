...
import NotificariManualeFields from "../Dashboard/NotificariManualeFields";

export default function NotificariManuale({ articles }) {
  // const { db } = useMockup();
            ...
            <Box>
              ...
              <Stack direction="column" alignItems="center">
                {isLoading ? (
                  ...
                  >
                    Nu sunt notificari manuale create
                  </Typography>
                ) : (
