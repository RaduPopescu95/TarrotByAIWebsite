  ...
  React.useEffect(() => {
    ...
    onAuthStateChanged(authenticated, (user) => {
      if (user) {
        ...
        const uid = user.uid;
        console.log("is user.......");
        if (uid === "LQheTX2moAhKbu72gaStkZgaGz32" || uid === "MSBePxFVcVO3vsfM5nwHr36ROfh2" || uid === "zFsAwNZA5bUonVRIQzRn2HZB3y62" || uid === "AW8kjQIhAiaJM5q0QgGlOKpGF2j1") {
          ...
          >
            <React.Fragment>
              ...
              <ListItemButton
                onClick={() =>
                  handleSelectedItem({
                    screen: "notificari-manuale",
                    text: "Notificari Manuale",
                  })
                }
              >
                <ListItemIcon
                  sx={{
                    color: selectedItem === "Notificari Manuale" ? "#ffc045" : "white",
                  }}
                >
                  <LibraryBooksIcon />
                </ListItemIcon>
