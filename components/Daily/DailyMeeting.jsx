  ...
  useEffect(() => {
    const initializeDailyRoom = async () => {
      ...
      try {
        ...
        console.log('🎥 [DAILY-CLIENT] Received room data:', {
        ...
        // Client gets basic URL with token only
        const dailyUrl = data.token 
          ? `${data.roomUrl}?t=${data.token}`
          : data.roomUrl;
        
        console.log('🎥 [DAILY-CLIENT] Redirecting to:', dailyUrl);
      ...
      <div className="main-wrapper home-one">
        ...
        <div style={styles.loadingContainer}>
          <div style={styles.loadingContent}>
            ...
            <h3>Se pregătește apelul video...</h3>
  ...
  return (
    <div className="main-wrapper home-one">
      ...
      <div style={styles.loadingContainer}>
        <div style={styles.loadingContent}>
          <div style={styles.spinner}></div>
          <h3>Redirecționare către Daily.co...</h3>
          <p>Vă rugăm să așteptați</p>
        </div>
      </div>
    </div>
