    ...
    try {
      ...
      signInWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          if (user.uid === "LQheTX2moAhKbu72gaStkZgaGz32" || user.uid === "MSBePxFVcVO3vsfM5nwHr36ROfh2" || user.uid === "zFsAwNZA5bUonVRIQzRn2HZB3y62" || user.uid === "AW8kjQIhAiaJM5q0QgGlOKpGF2j1") {
