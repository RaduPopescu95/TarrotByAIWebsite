...
export default function AdminConferinteGrupPage() {
  ...
  useEffect(() => {
    ...
    const testingAuth = localStorage.getItem('conferinte_testing_auth');
  ...
  const handlePasswordSubmit = (e) => {
    ...
    if (password === correctPassword) {
      ...
      localStorage.setItem('conferinte_testing_auth', 'authenticated');
    } else {
  ...
  const handleLogout = () => {
    localStorage.removeItem('conferinte_testing_auth');
        ...
        <div className="card shadow-lg" style={{ maxWidth: '400px', width: '100%', margin: '20px' }}>
          <div className="card-header bg-primary text-white text-center">
            <h4 className="mb-0">
              ...
              Acces Protejat - Testare Conferințe
            </h4>
          </div>
          <div className="card-body p-4">
            <div className="text-center mb-4">
              ...
              <p className="text-muted">
                Această secțiune este protejată pentru testarea funcționalităților live.
            ...
            <div className="text-center mt-4">
              <small className="text-muted">
                ...
                Această protecție este doar pentru testarea funcționalităților live
              </small>
            </div>
          </div>
        </div>
  ...
  // Main admin interface with logout option
  return (
    <div>
