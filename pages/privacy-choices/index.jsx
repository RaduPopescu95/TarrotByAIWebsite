...
const COPY = {
  ro: {
    ...
    adsBody: "În aplicația Cristina Zurba poți redeschide opțiunile de publicitate din Settings → Privacy options. Pentru permisiunea App Tracking Transparency, mergi în iOS la Settings → Privacy & Security → Tracking.",
  ...
  en: {
    ...
    adsBody: "In the Cristina Zurba app, you can reopen advertising choices from Settings → Privacy options. To change the App Tracking Transparency permission, go to iOS Settings → Privacy & Security → Tracking.",
