...
export default function YoutubeHelper() {
  ...
  // Încearcă întâi să preia subtitrările existente, iar dacă nu sunt disponibile, apelează endpoint-ul de generare.
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      {/* Dacă nu avem token, oferim opțiunea de autentificare */}
      {!accessToken && (
        <div>
