      ...
      <div className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <button onClick={() => router.push("/administrare")} className="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm">← Administrare</button>
...
export default function AnalyticsPage() {
  return (
    <>
      ...
      <LocalPasswordGate redirectTo="/administrare/login"><AnalyticsScreen /></LocalPasswordGate>
    </>
  );
}
