            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-center lg:text-left mb-16 lg:mb-0">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12">
                  <Link href="/consultatii" className="group relative px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold rounded-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/25 text-decoration-none">
                  ...
                  <Link href="/news" className="group px-8 py-4 bg-white/80 backdrop-blur-lg border border-white/30 text-gray-700 font-semibold rounded-2xl transform transition-all duration-300 hover:scale-105 hover:bg-white/90 hover:shadow-xl text-decoration-none">
                      ...
                      <div className="mb-12 pb-8 border-b-2 border-gray-100">
                        ...
                        {filterItem !== "All" && (
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
                            <span className="text-blue-800">Filtru activ: <strong>{filterItem}</strong></span>
                            <button 
