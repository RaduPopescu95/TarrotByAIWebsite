...
import { hasActivePremiumSource } from "./premiumSources";
...
export function explainPremiumAccess(userData) {
  ...
  if (hasActivePremiumSource(userData.premiumSources)) {
    return { hasAccess: true, reason: "provider_source_active", snapshot, now };
  }
