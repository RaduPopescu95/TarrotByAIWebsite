 ...
 * @returns {Promise<{ iosPremiumSubscriptionsEnabled: boolean, subscriptionSystemEnabled: boolean, iosBillingPremiumProvider: string, iosBillingAnalysesProvider: string, androidBillingPremiumProvider: string, androidBillingCoursesProvider: string, androidBillingAnalysesProvider: string, updatedAt?: Date, updatedBy?: string }>}
 */
 ...
 * @param {{ iosPremiumSubscriptionsEnabled?: boolean, subscriptionSystemEnabled?: boolean, iosBillingPremiumProvider?: string, iosBillingAnalysesProvider?: string, androidBillingAnalysesProvider?: string, vatPercentage?: number|string }} updates
