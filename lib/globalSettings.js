...
async function fetchGlobalSettings() {
  ...
  return {
    ...
    androidBillingPremiumProvider: normalizeAndroidBillingProvider(
      data.androidBillingPremiumProvider
    ),
    androidBillingCoursesProvider: "stripe",
 ...
 * @returns {Promise<{ subscriptionSystemEnabled: boolean, androidBillingPremiumProvider: string, androidBillingCoursesProvider: string, androidBillingAnalysesProvider: string, updatedAt?: Date, updatedBy?: string }>}
 */
 ...
 * @param {{ subscriptionSystemEnabled?: boolean, androidBillingPremiumProvider?: string, androidBillingAnalysesProvider?: string }} updates
